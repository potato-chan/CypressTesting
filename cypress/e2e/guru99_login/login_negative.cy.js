//The tests 1, 4, 5 were skipped because of a popup that is not caught by Cypress.
...
describe('Login page', () => {
  ...
  it.skip('KKP-1, The login functionality with with incorrect password', () => {
  ...
  it.skip('KKP-1, The login functionality with incorrect UserID', () => {
    cy.fieldsFillingIncorrect(data.incorrect.login, data.nominal.password);
  })

  it.skip('KKP-1, The login functionality with empty values', () => {
    cy.get('[type="submit"]')
    .click();
